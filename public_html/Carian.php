...
<html>
  ...
  <body class=sb-nav-fixed>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      <!-- Navbar Brand-->
      <a class="navbar-brand ps-3" href="LamanUtama.html">Sistem Pemantauan Agensi</a>
      <!-- Sidebar Toggle-->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <select class="form-select" aria-label="Senarai Agensi / Anak Syarikat / Badan Berkanun">
                        <option selected hidden> Agensi / Anak Syarikat / Badan Berkanun</option>
                        <option value="Agensi / Anak Syarikat">Agensi / Anak Syarikat</option>
                    ...
                    <div class="row">
                      <div class="col">
                        <br>
                        <select class="form-select" aria-label="Kerajaan Negeri / Persekutuan">
                        <option selected hidden>Kerajaan Negeri / Persekutuan</option>
                        <option value="Agensi / Anak Syarikat">Kerajaan Negeri</option>
                        <option value="Badan Berkanun">Persekutuan</option>
                      </select>
                      </div>
                    </div>
                      ...
                      <div class="col">
                        <br>
                        <select class="form-select" aria-label="Pinjaman / Bayaran / Tunggakan">
                        <option selected hidden>Pinjaman / Bayaran / Tunggakan</option>
                      ...
                      <div class="col">
                        <br>
                        <label class="col col-form-label">Dari</label>
                        <input type="date" class="form-control" id="DariCarian">
                        <label class="col col-form-label">Hingga</label>
                        <input type="date" class="form-control" id="HinggaCarian">
                      </div>
                    </div>
