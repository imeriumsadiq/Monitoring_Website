...
<html>
  ...
  <body class=sb-nav-fixed>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      ...
      <!-- Sidebar Toggle-->
      <button class="btn btn-link btn-sm order-1 order-lg-0 ms-5 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
      <!-- Navbar Search-->
                    ...
                    <table id="Laporan" class="display" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>Baki Pinjaman Pokok</th>
                          <th>Baki Tunggakan</th>
                        </tr>
                      </thead>
                      <tbody>
                       <?php
                      ...
                      <td><?php echo $row['BakiPinjamanPokokBaharuKN']?></td>
                      <td><?php echo $row['BakiTunggakanBaharuKN']?></td>
                      </tbody>
                      <?php
